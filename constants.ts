...
export const DEFAULT_ACTIVITY_TYPES: ActivityType[] = [
  ...
  { id: 'breast_feed', name: 'Breast Feed', category: 'FEEDING', icon: 'fa-person-breastfeeding', unit: 'minutes', color: 'bg-rose-100 text-rose-600' },
  { id: 'cup_feed', name: 'Cup Feed', category: 'FEEDING', icon: 'fa-glass-water', unit: 'ml', color: 'bg-blue-100 text-blue-600' },
  { id: 'sleep', name: 'Sleep', category: 'SLEEP', icon: 'fa-moon', unit: 'minutes', color: 'bg-indigo-100 text-indigo-600' },
];
